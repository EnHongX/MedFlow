            ...
            <el-col :span="12">
              <div class="config-card">
                ...
                <div class="config-card__body">
                  ...
                  <div class="config-card__desc">预约开始后多少分钟未签到视为迟到，前台列表显示迟到提示</div>
                  <div class="config-card__input">
            ...
            <el-col :span="12">
              <div class="config-card">
                ...
                <div class="config-card__body">
                  ...
                  <div class="config-card__desc">预约开始后多少分钟可标记爽约，爽约后号源释放给候补患者</div>
                  <div class="config-card__input">
...
async function fetchConfig() {
  try {
    ...
    if (res.ok) {
      const data = await res.json();
      clinicConfig.value = { cancelDeadlineHours: data.cancelDeadlineHours, advanceBookingDays: data.advanceBookingDays, lateThresholdMinutes: data.lateThresholdMinutes, noShowThresholdMinutes: data.noShowThresholdMinutes };
    }
